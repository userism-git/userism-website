...
function initTypewriterEffect() {
  ...
  //   0 → TYPING_FRACTION                    : text types character by character
  //   TYPING_FRACTION → +FREEZE_FRACTION     : freeze — nothing moves, scroll absorbed
  //   remaining buffer                       : before main-feed slides in
  const TYPING_FRACTION = 0.65;
  const FREEZE_FRACTION = 0.20;
  ...
  function tick() {
    ...
    // --- Phase 2: freeze — nothing happens, scroll is absorbed ---
    // (TYPING_FRACTION to TYPING_FRACTION + FREEZE_FRACTION is dead time)
